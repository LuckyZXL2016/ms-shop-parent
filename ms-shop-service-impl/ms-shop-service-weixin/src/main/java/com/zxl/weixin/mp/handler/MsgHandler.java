package com.zxl.weixin.mp.handler;

import com.zxl.constants.Constants;
import com.zxl.core.utils.RedisUtil;
import com.zxl.core.utils.RegexUtils;
import com.zxl.weixin.mp.builder.TextBuilder;
 ...
 */
@ComponentScan(basePackages = "com.zxl.core.utils")
@Component
@SuppressWarnings("static-access")
public class MsgHandler extends AbstractHandler {
	// 用户发送手机验证码提示
	@Value("${zxl.weixin.registration.code.message}")
	private String registrationCodeMessage;
	// 默认用户发送验证码提示
	@Value("${zxl.weixin.default.registration.code.message}")
